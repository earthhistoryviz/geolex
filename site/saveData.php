...
$list_names = ['id','title','period_value','agein_value','province_value','type_value','lithology_value','lower_value','upper_value','regional_value','fossil_value',
...
$sql = "UPDATE formation(name,period,age_interval,province,type_locality,lithology,lower_contact,upper_contact,regional_extent,fossils,age,depositional,additional_info,compiler)
