...
static_polygons = pygplates.FeatureCollection('PALEOMAP_PlatePolygons.gpml')
...
fig.savefig("Chris_PaleoMap_base_reconstrcution_1.png",dpi="300") # Do you need some kind of unique filename to prevent conflicts if multiple users are online?
