...
if ($uploadOk == 0) {
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
        ...
        echo "Sorry, there was an error uploading your file. upload_max_filesize = ".ini_get("upload_max_filesize").", post_max_size = ".ini_get("post_max_size").", memory_limit = ".ini_get("memory_limit").", failed when moving ".$_FILES["image"]["tmp_name"]." to $target_file.  FILES = ";
        print_r($_FILES);
    }
}
